...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            if ($('#addFramework').length) {
                $('#addFramework').dataTable();
            }
            
            if ($('#addComplexity').length) {
                $('#addComplexity').dataTable();
            }
            if ($('#addComponent').length) {
                $('#addComponent').dataTable();
            }
            if ($('#additionalParameter').length) {
                $('#additionalParameter').dataTable();
            }
        ...
        // Vertical Form Validation-Creation


        if ($('#verticalCreateForm').length) {
            $('#verticalCreateForm').validate({
                ...
                messages: {
                    verticalName: {
                        required: 'Please enter the vertical name'
                    },
                    verticalEmail: {
                        required: 'Please enter the vertical DL (email) address',
        ...
        //Get Project Form Validation
        if ($('#getProjectForm-validations').length) {
            $('#getProjectForm-validations').validate({
                ...
                messages: {
                	verticalId: {
                        required: 'Please select the vertical name'
                    },
                    account: {
      ...
      //Create Content Form Validation
        if ($('#createContent-form').length) {
            $('#createContent-form').validate({
                ...
                messages: {
                    ...
                    content: {
                        required: 'Please enter the content name',
                    },
                },
                errorPlacement: function (error, element) {
                    error.insertAfter(element.parent());
      ...
      //Parameter Selector Form Validation
        if ($('#parameterSelector-form').length) {
            $('#parameterSelector-form').validate({
                ...
                messages: {
                	selectedParameters: {
                        required: 'Please select the parameter name'
                    },
                },
      ...
      //Configure Component Form Validation
        if ($('#configureComponent-form').length) {
            $('#configureComponent-form').validate({
      ...
      //Configure Framework Form Validation
        if ($('#configureFramework-form').length) {
            $('#configureFramework-form').validate({
                ...
                messages: {
                	selectedFrameworks: {
                        required: 'Please select the framework name'
                    },
                },
                showErrors: function(errorMap, errorList) {
                    for (var error in errorMap) {
        ...
        //Configured Framework Form Validation
        if ($('#configuredFramework-form').length) {
            $('#configuredFramework-form').validate({
                ...
                messages: {
                	usage: {
                        required: 'Please enter percentage usage of framework',
                        digits: 'Digits only please'
                    },
                    weightage: {
                        required: 'Please enter the framework weightage',
                        digits: 'Digits only please'
                    },
                },
                showErrors: function(errorMap, errorList) {
        ...
        //Configure Component Form Validation
        if ($('#configureComplexity-form').length) {
            $('#configureComplexity-form').validate({
                ...
                messages: {
                	selectedComplexities: {
                        required: 'Please select the complexity name'
                    },
                },
                showErrors: function(errorMap, errorList) {
                    for (var error in errorMap) {
        ...
        //Configured Component Form Validation
        if ($('#configuredComplexity-form').length) {
            $('#configuredComplexity-form').validate({
                ...
                messages: {
                	complexityWeightage: {
                        required: 'Please enter the complexity weightage',
                        digits: 'Digits only please'
                    },
                    criteria: {
                        required: 'Please eneter the complexity criteria'
                    },
                },
                showErrors: function(errorMap, errorList) {
                    for (var error in errorMap) {
        ...
        //Configure Additional Parameter
        if ($('#configureAdditionalParameter-form').length) {
            $('#configureAdditionalParameter-form').validate({
        ...
        if ($('#createModule-form').length) {
            $('#createModule-form').validate({
        ...
        //Add Parameter Form Validation
        if ($('#addParmeter-form').length) {
            $('#addParmeter-form').validate({
      ...
      //Add Complexity Form Validation
        if ($('#addComplexity-form').length) {
            $('#addComplexity-form').validate({
                ...
                messages: {
                	complexityName: {
                        required: 'Please enter the complexity name'
                    },
                },
                errorPlacement: function (error, element) {
                    error.insertAfter(element.parent());
        ...
        //Add Framework Form Validation
        if ($('#addFramework-form').length) {
            $('#addFramework-form').validate({
                ...
                messages: {
                	name: {
                        required: 'Please enter the framework name'
                    },
                    weightage: {
                        required: 'Please enter the framework weightage',
                        digits: 'Digits only please'
                    ...
                    overridingComment: {
                        required: 'Please enter the frameworks overriding comment'
                    },
                },
                errorPlacement: function (error, element) {
                    error.insertAfter(element.parent());
        ...
        if ($('#addComponent-form').length) {
            $('#addComponent-form').validate({
                ...
                messages: {
                    ...
                    category: {
                        required: 'Please select the component category name'
                    },
                },
                errorPlacement: function (error, element) {
                    error.insertAfter(element.parent());
        ...
        if ($('#createProjectForm-validations').length) {
            $('#createProjectForm-validations').validate({
                ...
                messages: {
                    ...
                    geo: {
                        required: 'Please enter the GEO name'
                    },
                    oppurtunity: {
                        required: 'Please enter the oppurtunity'
                    },
                    salesExecutive: {
                        required: 'Please enter the Sales Executive name'
                    },
                    geoBDM: {
                        required: 'Please enter the GEO BDM name'
                    },
                    pursuitBDM: {
                        required: 'Please enter the PURSUIT BDM name'
                    },
                    solutionAchitect: {
                        required: 'Please enter the Solution Architect name'
                    },
                    verticalSME: {
                        required: 'Please enter the Vertical SME name'
                    },
                },
                errorPlacement: function (error, element) {
                    error.insertAfter(element.parent());
        ...
        $(".copy").click(function (e) {
            ...
            var href = $(this).attr('href');
            $('#copyModule').modal();
            $('#yesicopy').click(function () {
                window.open(href, '_self');
                $('#copyModule').modal('hide');
            });
        ...
        $(".configure").click(function (e) {
            e.preventDefault();
            var href = $(this).attr('href');
            $('#configureModule').modal();
            $('#yesiconfigure').click(function () {
                window.open(href, '_self');
                $('#configureModule').modal('hide');
            });
        ...
        $(".logout").click(function (e) {
            e.preventDefault();
            var href = "login.dell?logout";
            $('#Logout').modal();
            $('#yesilogout').click(function () {
            	 //   var href = $(this).find('.configure').attr("href");
            	  //var id = $(this).closest("td").children("a").attr("href");
            	  //console.log(id);
                window.open(href, '_self');
                $('#Logout').modal('hide');
            });
