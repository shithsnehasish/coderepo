...
<body>
	...
	<div style="width:95%;padding:16px 0px 0px 66px">
		...
		<td> &nbsp;</td>
		<td><input type="text" name="clientName" id="clientName" class="clientName" onblur="return validateName()"  /><span class="status"></span>
		...
		<td> &nbsp;</td>
		<td> <textarea name="clientAddress" id="clientAddress" onblur="return validateAddress()" ></textarea>
		...
		<td> &nbsp;</td>
		<td><input type="text" name="clientEmail" id="clientEmail" onblur="return validateEmail()" />
      <span id="clientEmailError" style="display: none;">You must enter a valid email address</span>
		...
		<td> &nbsp;</td>
		<td><input type="text" name="clientSPOC" id="clientSPOC"  onblur="return validateSPOC()" />
		...
		<td> &nbsp;</td>
		<td><input type="text" name="contact"  id="contact" onblur="return validateContact()">
      <span id="contactError" style="display: none;">You must enter a valid contact number</span>
		...
		<td><input type="submit" value="Add Client" class="myButton" /></td>
		</tr>
		</table>
		</form>
		</div>
