...
.body{
	...
	width: auto;
	height: auto;
	background-image: url(../GLITApp/images/login-BG.jpg);
...
.login input[type=text]{
	...
	border: 1px solid #5379fa !important;
	border-radius: 2px;
	color: #5379fa !important;
	font-family: 'Exo', sans-serif;
	font-size: 16px;
...
<body>
  ...
  <div class="body"></div>
		<div class="grad"></div>
		<div class="header">
			<div>Go-Live<span>Interaction</span> <br/>Tracking
		</div>
		</div>
		<br>
		<div class="login">
		<form id="login" action="<c:url value='j_spring_security_check' />" method='POST'>
				<input type="text" placeholder="username" name="j_username" autofocus="autofocus"><br>
				<input type="password" placeholder="password" name="j_password"><br>
				<input type="submit" value="Login">
</form>
		</div>

  <script src='../GLITApp/js/jquery.js'></script>
</body>
