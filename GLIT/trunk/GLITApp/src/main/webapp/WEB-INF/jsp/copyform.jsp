...
<body>
	...
	<jsp:include page="header.jsp"></jsp:include>
        ...
        <a href="#" class="active">Copy Form </a>
		...
		<form action="addNewForm.spring" method="post" onsubmit="return validate(this); return validateForm();" >
		<div style="width:95%;padding:16px 0px 0px 66px">
		...
		<td> &nbsp;</td>
		<td><input type="text" name="formName" class="formName required" value="Copy_${formName}" /> &nbsp;<span class="status"></span></td>
		</tr>
		</table>
		</div>
		</div>
        ...
        <td><input type="text" id="textLimit" name="textLimit" value="${field.fieldLimit }" class="required textLimit" /></td>
...
var validate = (function() {
  ...
  return function (form) {
    ...
    function insertRow(){
          ...
          document.getElementById("rowcount").value= rows-1;
    }
</SCRIPT>
<script type="text/javascript">
$(document).ready(function () {
